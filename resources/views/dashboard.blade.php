                        ...
                        <div class="card-body grettings-box-two position-relative z-1 p-0">
                            <div class="row align-items-center h-100">
                                ...
                                <div class="col-lg-6 d-md-block d-none mt-auto">
                                    <img src="{{ asset('edmate/assets/images/thumbs/gretting-thumb.png') }}" alt="">
                                </div>
                            </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="flex-between flex-wrap">
                                        ...
                                        <div class="d-flex gap-8 mt-12 flex-column w-50-perc ps-8">
                                            <div class="progress w-100 bg-main-two-100 rounded-pill h-4"
                                                role="progressbar" aria-label="Basic example" aria-valuenow="80"
