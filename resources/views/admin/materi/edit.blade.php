        ...
        <div class="dashboard-body">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center gap-16 mb-24">
                    ...
                    <a href="{{ route('admin.materi.index') }}" class="btn btn-outline-secondary rounded-pill">Kembali ke daftar</a>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.materi.update', $materi) }}">
                            @csrf
                            @method('PUT')
