        ...
        <div class="dashboard-body">
            <div class="container-fluid">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-16 mb-24">
                    <div>
                        <h1 class="h3 mb-4">Decision Tree Viewer</h1>
                        <p class="text-gray-400 mb-0">Struktur di bawah menunjukkan urutan slot materi berdasarkan data kurikulum yang tersimpan di database.</p>
                    </div>
                </div>
